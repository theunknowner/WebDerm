...
public:
	...
	deque< deque<String> > calcMainColorMatrix(Mat &img, deque< deque<String> > &windowVec,String name);
	...
	void writeMainColorMatrix(Mat &img, deque< deque<String> > &windowVec, String name);
